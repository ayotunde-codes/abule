        ...
        <div
          ...
          ref={(e) => {
            ...
            if (this.focusEarliestSelectionCMD) {
              ...
              const selection = column.getElementsByClassName('selection')[
                this.earliestSelection.selection
              ];
        ...
        >
          <div className="row week-days">
            ...
            {days.map((day, index) => (
              <div>
                <div
                  className={`week-day${timelineData[day].length ? ' active' : ''
                    }`}
                >
                        ...
                        {timeRangeData.map((timeRange, inedx) => {
                          ...
                          return (
                            <div
                              ...
                              tabIndex={0}
                              style={{
                                width: `calc(${timeRange.spanRight * 100}% + ${timeRange.spanRight
                                  }px)`,
